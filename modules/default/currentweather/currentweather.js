...
Module.register("currentweather",{
  ...
  notificationReceived: function(notification, payload, sender) {
    switch (notification) {
      ...
      case 'NOTIFY_FAKE_INDOOR_TEMPERATURE':
        this.indoorTemperature = this.roundValue(payload);
        this.updateDom(this.config.animationSpeed);
        break;
      case 'INDOOR_HUMIDITY':
      case 'NOTIFY_FAKE_INDOOR_HUMIDITY':
        this.indoorHumidity = this.roundValue(payload);
        this.updateDom(this.config.animationSpeed);
        break;
      case 'NOTIFY_FAKE_WEATHER_TYPE':
        switch (payload) {
          case 'Clear':
            this.weatherType = this.config.iconTable['01d'];
            break;
          case 'Clouds':
            this.weatherType = this.config.iconTable['03d'];
            break;
          case 'Rain':
            this.weatherType = this.config.iconTable['10d'];
            break;
          case 'Snow':
            this.weatherType = this.config.iconTable['13d'];
            break;
        }
        this.updateDom(this.config.animationSpeed);
        break;
      case 'NOTIFY_FAKE_OUTDOOR_TEMPERATURE':
        console.log(payload);
